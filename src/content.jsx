...
const Content = () => {
  ...
  return (
    <div className="px-4 py-8 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-4">
      <div className="max-w-xl mb-10 md:mx-auto lg:max-w-2xl md:mb-12">
        ...
        <form className="mb-8" onSubmit={(e) => handleSubmit(e)}>
          <div className="relative">
            ...
            <button
              type="submit"
              className=" cursor-pointer text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl px-4 py-2 "
            >
              Search
            </button>
          </div>
